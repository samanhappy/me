...
![OpenClaw 整体架构](/assets/openclaw-core-concepts/architecture-overview.png)
...
![Agent-Session-Channel 关系图](/assets/openclaw-core-concepts/agent-session-channel.png)
...
![Session 生命周期](/assets/openclaw-core-concepts/session-lifecycle.png)
